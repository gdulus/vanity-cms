...
// grails.resources.processing.enbled = false
grails.resources.adhoc.patterns = ['/connections-app/*', '/images/*', '/css/*', '/js/*', '/plugins/*']
grails.resources.adhoc.includes = ['/connections-app/**', '/images/**', '/css/**', '/js/**', '/plugins/**']

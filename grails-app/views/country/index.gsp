    ...
    <div class="span9">
        ...
        <g:else>
            <table class="table table-striped">
                <tr>
                    <th style="width:25%"><g:message code="vanity.cms.locations.country.name"/></th>
                    <th style="width:25%"><g:message code="vanity.cms.locations.country.isoCode"/></th>
                    <th></th>
                </tr>

    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            <g:else>
                <table class="table table-striped">
                    ...
                    <g:each in="${paginationBean.elements}" var="element" status="i">
                        <tr>
                            ...
                            <td class="options">
                                <g:link action="delete" id="${element.id}" class="btn btn-danger delete"><g:message code="vanity.cms.delete" /></g:link>
                ...
                <g:paginate next="Forward" prev="Back" maxsteps="0" controller="celebrity" action="index" total="${paginationBean.totalCount}" />
